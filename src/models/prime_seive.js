// function that takes in a numerical value, then will output an array of primes of the specified length starting from the smallest prime (2) that are contained in this range of natural numbers
